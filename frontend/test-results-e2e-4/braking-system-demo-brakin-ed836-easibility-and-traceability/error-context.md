...
Locator: getByText('The requirement uses vague terms: quickly, user-friendly.')
Expected: visible
Error: strict mode violation: getByText('The requirement uses vague terms: quickly, user-friendly.') resolved to 2 elements:
    1) <p class="MuiTypography-root MuiTypography-body2 css-1q1fxgw">The requirement uses vague terms: quickly, user-f…</p> aka getByText('The requirement uses vague terms: quickly, user-friendly.', { exact: true })
    2) <p class="MuiTypography-root MuiTypography-body2 css-1q1fxgw">ambiguous_terms: The requirement uses vague terms…</p> aka getByText('ambiguous_terms: The')

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByText('The requirement uses vague terms: quickly, user-friendly.')
