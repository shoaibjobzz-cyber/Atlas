...
Locator: getByText('user-friendly')
Expected: visible
Error: strict mode violation: getByText('user-friendly') resolved to 4 elements:
    1) <p class="MuiTypography-root MuiTypography-body1 css-11a9a8v">The software shall quickly provide user-friendly …</p> aka getByText('The software shall quickly')
    2) <p class="MuiTypography-root MuiTypography-body2 css-ietekv">user-friendly brake status messages</p> aka getByText('user-friendly brake status messages', { exact: true })
    3) <p class="MuiTypography-root MuiTypography-body2 css-1q1fxgw">The requirement uses vague terms: quickly, user-f…</p> aka getByText('The requirement uses vague terms: quickly, user-friendly.', { exact: true })
    4) <p class="MuiTypography-root MuiTypography-body2 css-1q1fxgw">ambiguous_terms: The requirement uses vague terms…</p> aka getByText('ambiguous_terms: The')

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByText('user-friendly')
